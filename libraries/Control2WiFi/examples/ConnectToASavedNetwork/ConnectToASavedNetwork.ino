/* ConnectToASavedNetwork.ino
   ...
   network).
   This behaviour is achieved thanks to a memorization structure integrated into the WiFi chip's
...
void setup() {
  ...
  if (WiFi.status() == WL_NO_WIFI_MODULE_COMM) {
    /*
       ...
       the communication between companion chip and the 328P fail.
    */

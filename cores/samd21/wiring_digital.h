 ...
 */
extern void digitalWrite( uint32_t ulPin, uint32_t dwVal ) ;
...
extern void ledBuiltinSetColor(uint8_t r, uint8_t g, uint8_t b);
extern void ledBuiltinSetBrightness(uint8_t br);
#endif

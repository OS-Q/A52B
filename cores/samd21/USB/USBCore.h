...
#define D_INTERFACE(_n,_numEndpoints,_class,_subClass,_protocol, iInterface) \
	{ 9, 4, _n, 0, _numEndpoints, _class,_subClass, _protocol, iInterface }
...
#define D_IAD(_firstInterface, _count, _class, _subClass, _protocol, ifunction) \
	{ 8, 11, _firstInterface, _count, _class, _subClass, _protocol, ifunction }
